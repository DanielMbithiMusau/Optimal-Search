...
from searching import a_star_search, breadth_first_search, depth_first_search, reconstruct_path
import uuid
...
def on_click():
     ...
     if "Breadth First Search" == algo.get():
         ...
         messagebox.showinfo('Distance',str(get_distance(path)) + "km")
         url = f"file:///C:/Users/Daniel Musau/OneDrive/Documents/Bsc. Computer Science/4th Year/4.1/ICS 2405 Knowledge Based Systems/Assignments/Road searching/Optimal search/{filename}.html"
         webbrowser.open(url,new=2)
         root.destroy()
         os.system('python Searchgeneration.py')    
...
bg = PhotoImage(file = "kenya.png")
labela = Label(root,image=bg)
labela.place(x=150, y=0)
root.title("Optimal Route finding app")
